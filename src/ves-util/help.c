...
const char *VEShelp =
       ...
       "  -A LOGIN, --primary=...       Select a Primary Vault,\n"
       "                                LOGIN = \"email\" | \"ves:////email\"\n"
       "  -T TOKEN, --token=...         Authenticate using a Session Token\n"
       ...
       "                                All Stream Cipher actions require -o Vaut Item\n"
